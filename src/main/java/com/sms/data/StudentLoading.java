...
public class StudentLoading {
	public static Set<Student> loadStudents() {
		...
		students.add(new Student(1L,1001 ,"Aman", "Gupta", "aman@gmail.com", "1234567890", new Date(2007, 02, 20), true,
				...
				new LinkedHashSet<>(
						Arrays.asList(new Address(1L, "Lane5", "Jaipur", "Rajasthan", "India", 123456,AddressType.POSTAL.getAddressType()))),
		...
		students.add(new Student(2L,1002,"Kishina", "Dubey","kishina@gmail.com","5467890112",new Date(2007, 11, 06),true,
				...
				new LinkedHashSet<>(
						Arrays.asList(new Address(2L, "Street 2", "Jaipur", "Rajasthan", "India", 302019,AddressType.PERMANENT.getAddressType()))),
				classService.getClass("I")));
		...
		address1.setAddressType(AddressType.PERMANENT.getAddressType());
		...
		Address address2 = new Address(4L, "StreetPink", "Jaipur", "Rajasthan", "India", 302018,AddressType.PERMANENT.getAddressType());
		Address address3 = new Address(5L, "StreetGreen", "Jaipur", "Rajasthan", "India", 302018,AddressType.POSTAL.getAddressType());
		...
		Address address4 = new Address(6L,"Lane ManSingh","Jaipur","Rajasthan","India",302019,AddressType.PERMANENT.getAddressType());
		...
		students.add(new Student(6L,3002 ,"Vidushi", "Gupta", "vidu@gmail.com", "1244567890", new Date(2005, 12, 10), true,
				Gender.FEMALE.getGender(),
				new LinkedHashSet<>(
						Arrays.asList(new Address(7L, "Lane51", "Jaipur", "Rajasthan", "India", 302019, AddressType.PERMANENT.getAddressType()))),
				classService.getClass("III")));
		
		students.add(new Student(7L,4001 ,"Janhvi", "Sharma", "jahnvi@gmail.com", "12567890", new Date(2004, 02, 10), true,
				Gender.FEMALE.getGender(),
				new LinkedHashSet<>(
						Arrays.asList(new Address(8L, "Lane2", "Jaipur", "Rajasthan", "India", 123456,AddressType.PERMANENT.getAddressType()))),
				classService.getClass("IV")));
		
		students.add(new Student(8L,5001 ,"Amina", "Khan", "amina@gmail.com", "1234567899", new Date(2003, 3, 23), true,
				Gender.FEMALE.getGender(),
				new LinkedHashSet<>(
						Arrays.asList(new Address(9L, "Lane56", "Jaipur", "Rajasthan", "India", 123456, AddressType.PERMANENT.getAddressType()))),
